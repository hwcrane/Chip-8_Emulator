...
export class CPUWasm {
    ...
    static __wrap(ptr) {
        const obj = Object.create(CPUWasm.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_cpuwasm_free(ptr);
    }
    /**
    */
    constructor() {
        var ret = wasm.cpuwasm_new();
        return CPUWasm.__wrap(ret);
    }
    /**
    */
    tick() {
        wasm.cpuwasm_tick(this.ptr);
    }
    /**
    */
    tick_timers() {
        wasm.cpuwasm_tick_timers(this.ptr);
    }
    /**
    */
    reset() {
        wasm.cpuwasm_reset(this.ptr);
    }
    /**
    ...
    */
    keypress(event, pressed) {
        wasm.cpuwasm_keypress(this.ptr, addHeapObject(event), pressed);
    }
    /**
    * @param {Uint8Array} data
    */
    load_rom(data) {
        wasm.cpuwasm_load_rom(this.ptr, addHeapObject(data));
    }
    /**
    * @param {number} scale
    */
